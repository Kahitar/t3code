...
export const ProviderKind = Schema.Literals(["codex", "claudeAgent", "jeanClaude"]);
...
export const JeanClaudeModelSelection = Schema.Struct({
  provider: Schema.Literal("jeanClaude"),
  model: TrimmedNonEmptyString,
  options: Schema.optionalKey(Schema.Struct({})),
});
export type JeanClaudeModelSelection = typeof JeanClaudeModelSelection.Type;

export const ModelSelection = Schema.Union([
  CodexModelSelection,
  ClaudeModelSelection,
  JeanClaudeModelSelection,
]);
