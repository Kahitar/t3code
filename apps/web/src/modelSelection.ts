...
const PROVIDER_CUSTOM_MODEL_CONFIG: Record<ProviderKind, ProviderCustomModelConfig> = {
  ...
  jeanClaude: {
    provider: "jeanClaude",
    title: "Jean-Claude",
    description: "Save additional Jean-Claude model slugs for the picker and `/model` command.",
...
export function getCustomModelOptionsByProvider(
  ...
  return {
    ...
    jeanClaude: getAppModelOptions(
      settings,
      providers,
      "jeanClaude",
      selectedProvider === "jeanClaude" ? selectedModel : undefined,
    ),
  };
}
